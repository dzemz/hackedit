...
macro (create_test target libs)
    configure_file(${CMAKE_SOURCE_DIR}/scripts/cmake/test_main.cpp.in test_main.cpp)
...
macro(COPY_QML_FILES TARGET_NAME FILES DESTINATION)
    add_custom_target(${TARGET_NAME} ALL COMMENT "Copying QML files...")
    foreach(PATH ${FILES})
